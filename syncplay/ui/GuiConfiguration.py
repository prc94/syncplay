...
class ConfigDialog(QtWidgets.QDialog):
    ...
    def addBasicTab(self):
        ...
        self.adminpassLabel = QLabel(getMessage("admin-password-label"), self)
        self.adminpassTextbox = QLineEdit(self)
        self.adminpassTextbox.setEchoMode(QLineEdit.Password)
        self.adminpassTextbox.setText(config['adminPassword'] if config['adminPassword'] else "")
        self.adminpassLabel.setObjectName("adminPassword")
        self.adminpassTextbox.setObjectName(constants.LOAD_SAVE_MANUALLY_MARKER + "adminPassword")
        ...
        self.connectionSettingsLayout.addWidget(self.adminpassLabel, 2, 0)
        self.connectionSettingsLayout.addWidget(self.adminpassTextbox, 2, 1)
        self.connectionSettingsLayout.addWidget(self.usernameLabel, 3, 0)
        self.connectionSettingsLayout.addWidget(self.usernameTextbox, 3, 1)
        self.connectionSettingsLayout.addWidget(self.defaultroomLabel, 4, 0)
        self.connectionSettingsLayout.addWidget(self.editRoomsButton, 4, 2, Qt.AlignRight)
        self.connectionSettingsLayout.addWidget(self.roomsCombobox, 4, 1)
