...
UNIT = ["suite_unit.py", "suite_cap.py", "suite_osd.py", "suite_admin.py", "suite_tracks.py", "suite_domains.py", "suite_afk.py", "suite_joinguard.py", "suite_fileswitch.py", "suite_joinprop.py", "suite_lag.py", "suite_lua.py", "suite_overlay.py", "suite_updater.py"]
