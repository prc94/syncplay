...
UNIT = ["suite_unit.py", "suite_cap.py", "suite_osd.py", "suite_admin.py", "suite_tracks.py", "suite_lua.py"]
E2E = ["suite_e2e.py", "suite_e2e2.py", "suite_osd_e2e.py", "suite_admin_e2e.py", "suite_tracks_e2e.py"]
