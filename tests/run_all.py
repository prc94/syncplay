...
UNIT = ["suite_unit.py", "suite_cap.py", "suite_osd.py", "suite_admin.py", "suite_tracks.py", "suite_domains.py", "suite_afk.py", "suite_joinguard.py", "suite_joinprop.py", "suite_lua.py"]
